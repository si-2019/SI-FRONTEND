...
export class dateTimePickerr extends Component {
  ...
  state = {
    ...
    { 
      ...
      axios.post("http://localhost:3001/promjenaRoka/"+this.props.idPredmet+"/"+yyyyNew+"/"+mmNew+"/"+ddNew).then()
      {
        console.log("http://localhost:3001/promjenaRoka/"+this.props.idPredmet+"/"+yyyyNew+"/"+mmNew+"/"+ddNew)
