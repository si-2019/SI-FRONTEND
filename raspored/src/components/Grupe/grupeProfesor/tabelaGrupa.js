...
export class tabela extends Component {
    ...
    {     
        ...
        axios.post("http://localhost:3001/removeStudentFromGroup/"+this.props.grupa.studenti[index].idStudent+"/"+this.props.grupa.idGrupaTermina).then()
        {
            console.log("http://localhost:3001/removeStudentFromGroup/"+this.props.grupa.studenti[index].idStudent+"/"+this.props.grupa.idGrupaTermina)
