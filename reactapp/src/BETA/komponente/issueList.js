        ...
        return (
            <div>
                ...
                >
                    ...
                    <table class="table table-hover" id="InProgressIssueTable">
                        <thead>
                            <tr>
                            <th scope="col">Status</th>
                            <th scope="col">Naslov</th>
                            ...
                            <tbody>
                                {this.state.dataInProgress.map(item => <tr class="table-light"
                                /*Active key = {item.naslov,item.poruka}*/>
                                <td>{item.status}</td>
                                <td><a href="#">{item.naslov}</a></td>
                                <td colSpan="2">{item.poruka}</td>
                    ...
                    <table class="table table-hover" id="ResolvedIssueTable">
                        <thead>
                            <tr>
                            <th scope="col">Status</th>
                            <th scope="col">Naslov</th>
                            ...
                            <tbody>
                                {this.state.dataResolved.map(item => <tr class="table-light"
                                /*Active key = {item.naslov,item.poruka}*/>
                                <td>{item.status}</td>
                                <td><a href="#">{item.naslov}</a></td>
                                <td colSpan="2">{item.poruka}</td>
