...
class DodajNovuSalu extends Component {
    ...
    handleSubmit(event) {
      if(this.validiraj()){
        console.log("Naziv"+this.state.naziv + "kapacitet " + this.state.kapacitet +"bool" + this.state.namjena);
        this.postSala();
      }   
    }
            ...
            <div class="card" id="kartica">
              ...
              <Form.Row>
                <Col style={{textAlign: "left"}}>
                  ...
                  <Form.Control type="text" name="name" required value={this.state.naziv} onChange={this.handleNazivInput}> 
                  </Form.Control>
                </Col>
              </Form.Row>
              <Form.Row>
                <Col style={{textAlign: "left"}}>
                  ...
                  <Form.Control min="1" max="200" type="number" value={this.state.kapacitet} onChange={this.handleKapacitetInput}>
                  </Form.Control>
                </Col>
              </Form.Row>
              <div className="form-group" id="check">
                <div class="custom-control custom-checkbox">
                  <input type="checkbox" class="custom-control-input" id="customCheck1" onChange={this.handleBoolInput} ></input>
