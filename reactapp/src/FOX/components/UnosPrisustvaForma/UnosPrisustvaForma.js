        ...
        <div id="unosPrisustvaFormaID">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle mb-2 text-muted">Unos prisustva za sve studente omogućava brz unos prisustva za sve.</h6>
                    <br/>
                    <div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle mb-2 text-muted">Unos prisustva pojedinačno omogućava unos prisustva za svakog studenta posebno.</h6>
                    <br/>
                    <div>
