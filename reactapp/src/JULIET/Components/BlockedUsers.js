    ...
    render(){
        return(
            <form  onSubmit={this.onSubmit.bind(this)} style={{width: '100%', paddingTop: '5px'}}>
                ...
                <input  id="juliet-event-button" className="btn btn-outline-primary" type="submit" value="Block this user" style={{width: '100%', background: '#2C3E50', color: 'white', border: 'none'}}/>
            </form>
        )
    }
