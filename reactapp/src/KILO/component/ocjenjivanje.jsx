  ...
  handleClick = event => {
    ...
    switch (ime) {
      ...
      case "ok": {
        ...
        //KADA ZOVNE DIREKTNO HANDLE, NE PODESI SE STATE JOS UVIJEK ZA RENDAJ OPET
        //ZBOG TOGA TREBA JOŠ JEDAN REFRESH, BEZ OVOGA RADI REGULARE BEZ DODATNOG REFRESHA
