...
import PodnesiZahtjev from "./US_14_i_20/PodnesiZahtjev";
...
function PotvrdeRouter() {
  return (
    <Fragment>
      ...
      <Route path="/Lima/potvrde/Podnesi_zahtjev" component={PodnesiZahtjev} />
...
function Paths() {
  return (
    <ul>
      <li>
        <Link to="/Lima/potvrde/US_23">
          <div className="btn btn-primary">US_23</div>
        </Link>
        <Link to="/Lima/potvrde/US_21">
          <div className="btn btn-primary">US_21</div>
        </Link>
        <Link to="/Lima/potvrde/US_18">
          <div className="btn btn-primary">US_18</div>
        </Link>
        <Link to="/Lima/potvrde/Podnesi_zahtjev">
          <div className="btn btn-primary">Podnesi zahtjev</div>
        </Link>
