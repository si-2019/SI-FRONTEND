...
import PrisustvoPoPredmetu from '../../LIMA/Student/Izvjestaji/components/Dijagrami/PrisustvoPoPredmetu.js';
...
class PrisustvoPoPredmetuCard extends React.Component {
          ...
          {this.state.show ?
            <div style={{ width: '100%', height: '100%',  margin:"0"}}>
                <Card style={{ width: '100%', height: '100%', backgroundColor:this.state.boja, margin:"0"}}>
                    ...
                    <div style={{width: '100%',  display: 'flex',justifyContent:'space-between'}}>
                        {<h3 style={{color:"white"}} >Prisustvo po predmetu</h3>}
                    ...
                    <Card.Body>
                        ...
                        <PrisustvoPoPredmetu predmetId={this.state.idPredmet} godinaId={this.state.idGodina}/>
                    </Card.Body>
            ...
            <div className={"center2"} >
                <div className={"center3"}  onClick={this.showHide} style={{ backgroundColor:"light_green" }}>
                    <p className={"centerp2"}>Dodaj prisustvo po predmetu</p>
                </div>
            </div>
          }
        </div>  
  ...
  export default PrisustvoPoPredmetuCard;