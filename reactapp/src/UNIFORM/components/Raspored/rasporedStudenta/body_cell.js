...
export class Body_Cell extends Component {
 ...
 handleSignalString (poruka) {
  ...
  handleClick(event) {
    ...
    {      
      if(!(this.state.title == undefined || this.state.title==""))
      {
        ...
        console.log('https://si2019uniform.herokuapp.com/addZabiljeska'+'/'+this.props.termin.biljeska+'/'+this.props.idStudenta+'/'+this.props.termin.id+'/'+this.props.termin.ispit);
        axios({
          method:'get',
          url:'https://si2019uniform.herokuapp.com/addZabiljeska'+'/'+this.props.termin.biljeska+'/'+this.props.idStudenta+'/'+this.props.termin.id+'/'+this.props.termin.ispit,
          responseType:'json'
        })
      ...
      {
        this.props.termin.biljeska = this.state.title;
        console.log('https://si2019uniform.herokuapp.com/updateZabiljeska'+'/'+this.state.title+'/'+this.props.idStudenta+'/'+this.props.termin.id+'/'+this.props.termin.ispit);
        axios({
          method:'get',
          url:'https://si2019uniform.herokuapp.com/updateZabiljeska'+'/'+this.state.title+'/'+this.props.idStudenta+'/'+this.props.termin.id+'/'+this.props.termin.ispit,
          responseType:'json'
        })
          .then(function (response) {
            var isTrueSet = (response.data.success == 'true'); 
  ...
  handleDestroy(event) {
    ...
    this.props.termin.biljeska = this.state.title;
    console.log('https://si2019uniform.herokuapp.com/deleteZabiljeska'+'/'+this.props.idStudenta+'/'+this.props.termin.id+'/'+this.props.termin.ispit);
      axios({
        method:'get',
        url:'https://si2019uniform.herokuapp.com/deleteZabiljeska'+'/'+this.props.idStudenta+'/'+this.props.termin.id+'/'+this.props.termin.ispit,
        responseType:'json'
      })
        .then(function (response) {
          var isTrueSet = (response.data.success == 'true'); 
